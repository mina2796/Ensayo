...
setwd("F:/Documents/Doctorado/Tesis/Informatics/R_Scripts/SyntecData/")
setwd("./data/") 
unlink(dir("./data/"))
...
library(rstan)
setwd("F:/Documents/Doctorado/Tesis/Informatics/R_Scripts/SyntecData/data/fresqueau") #need to be defined to get orignldf
...
setwd("F:/Documents/Doctorado/Tesis/Informatics/R_Scripts/SyntecData/data/fresqueau/outstab")
...
write.table(format(n05, trim=T, digits=4), "FQTablaOuts.txt", row.names=F, quote=F, sep=",")
